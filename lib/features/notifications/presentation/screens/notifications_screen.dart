...
import '../../../history/presentation/widgets/order_summary_card.dart' show OrderActionButton;
...
class _NotificationsScreenState extends ConsumerState<NotificationsScreen> {
  ...
  Future<void> _markAllRead() async {
    ...
    await ref.read(notificationsRepositoryProvider).markAllAsRead(restaurant.id);
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: notification.isRead
            ? null
            : () => ref.read(notificationsRepositoryProvider).markAsRead(notification.id).then(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (notification.type == 'order_accepted' && notification.orderId != null) ...[
                const SizedBox(height: 12),
                SizedBox(
                  ...
                  child: OrderActionButton(
                    label: 'View Invoice',
                    filled: false,
                    onPressed: () => context.push('${AppRoutes.invoiceView}/${notification.orderId}'),
                  ),
                ),
              ],
            ],
